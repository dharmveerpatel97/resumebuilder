import { FONT_SIZE_OPTIONS } from '../data/typography'
import type { ResumeTypography, TextStyle } from '../data/typography'
...
const roles: { key: keyof ResumeTypography; label: string; hint: string }[] = [
...
export function TypographyPicker({ typography, onChange }: TypographyPickerProps) {
  const updateRole = (key: keyof ResumeTypography, patch: Partial<TextStyle>) => {
    onChange({
      ...typography,
